  ...
  return (
    <div>
      ...
      <div className="ide-container">
        <div className="ide-title">Code Editor</div>
        
        <div className="language-dropdown-container">
          <h3 className="language-label">Select Language:</h3>
          <select id="languageDropdown" onChange={handleLanguageChange} className="language-dropdown">
